...
#       sh substitution-HIVp.sh 1NH0 84 VAL n
...
then
	...
	echo
	echo "    Examples:"
	echo "		./substitution-HIVp.sh 1NH0 84 VAL y"
	echo "		sh substitution-HIVp.sh 1NH0.pdb 84 val YES"
	echo "		sh substitution-HIVp.sh -m I84V 1NH0.pdb Yes"
	echo
    exit 0
fi
